/******/ (() => { // webpackBootstrap
/*!****************************************!*\
  !*** ./resources/docs/js/api-table.js ***!
  \****************************************/
...
function setCurlVariable(id, query) {
  ...
  if (query) {
    if (value && value.length > 0) {
      document.getElementById('curl_' + id).innerHTML = '&' + id + '=' + encodeURIComponent(value);
    } else {
...
function setFailureTip(message) {
  var tip = document.getElementById('failure_tip');
 ...
 */
window.setupApiTable = function (ids, action) {
  ...
  var button = document.getElementById('at-action-button');
  button.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var fields, _i2, _Object$keys2, _id, _value, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // trackAction();
          fields = {};
          for (_i2 = 0, _Object$keys2 = Object.keys(ids); _i2 < _Object$keys2.length; _i2++) {
            _id = _Object$keys2[_i2];
            _value = document.getElementById(_id).value.trim();
            fields[_id] = _value;
          }
          _context.prev = 2;
          _context.next = 5;
        ...
        case 10:
          ...
          document.getElementById("result").innerHTML = _context.t0;
