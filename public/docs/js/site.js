...
var COMPONENT_SELECTOR = '[data-headings-anchors]';
var HEADINGS_SELECTOR = 'h1, h2, h3, h4, h5, .def';
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  var components = document.querySelectorAll(COMPONENT_SELECTOR);
  var _loop = function _loop() {
    var headings = components[i].querySelectorAll(HEADINGS_SELECTOR);
    var _loop2 = function _loop2(_i) {
      if (!headings[_i].classList.contains('reference-button__heading')) {
        var tooltip = (0,tippy_js__WEBPACK_IMPORTED_MODULE_2__["default"])(headings[_i], {
          content: 'Copied!',
          theme: 'translucent',
          placement: 'top-start',
          distance: 5,
        ...
        var clipboard = new (clipboard__WEBPACK_IMPORTED_MODULE_0___default())(headings[_i], {
          text: function text() {
            return "".concat(window.location.origin).concat(window.location.pathname, "#").concat(headings[_i].getAttribute('id'));
          }
        });
